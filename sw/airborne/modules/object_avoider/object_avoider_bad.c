...
#define OUT_OF_BOUNDS_TURN_DEG 35.0f
// *** TUNING: Distance to move forward after turning when OOB. Should be large enough to re-enter zone. ***
#define OUT_OF_BOUNDS_PROBE_DIST (WAYPOINT_DISTANCE * 3.0f) // Adjusted Probe Distance
